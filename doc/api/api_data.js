define({ "api": [
  ...
  },
  {
    ...
    "type": "get",
    "url": "/roles",
    "title": "Get all user and their roles.",
    "header": {
      "fields": {
        "Header": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -H \"Authorization:Bearer <token>\" http://localhost:80/roles",
        "type": "curl"
      }
    ],
    "sampleRequest": [
    ...
    "version": "0.0.0",
    "filename": "app/Http/Controllers/RolesController.php",
    "groupTitle": "Roles"
  },
  {
    "group": "Task",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i -H \"Authorization:Bearer <token>\" http://localhost:80/users/1/role/2",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "http://localhost:80/api/v0_01/users/1/role/2"
      }
    ],
    "version": "0.1.0",
    "filename": "app/Http/Controllers/UserController.php",
